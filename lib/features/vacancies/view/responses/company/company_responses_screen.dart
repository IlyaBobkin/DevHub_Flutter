...
class _CompanyResponsesScreenState extends State<CompanyResponsesScreen> {
    ...
    return Scaffold(
      ...
      body: _isLoading
        ...
        itemBuilder: (context, index) {
          ...
          final vacancyTitle = response['vacancy_title'] ?? response['item_title'] ?? 'Не указана';
          final applicantName = response['applicant_name'] ?? 'Не указан';
